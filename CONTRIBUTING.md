# Contributing to *Docker-env-kobuki*
...
The preferred way to contribute to *docker-env-kobuki* is to fork the main repository on Gitlab, then submit a "pull request"
(PR):

1. Fork the [project repository](git@github.com:helloric/docker-env-kobuki.git):
   click on the 'Fork' button near the top of the page. This creates a copy of
   the code under your account on the Gitlab server.

3. Clone this copy to your local disk:

        $ git clone git@github.com:YourLogin/docker-env-kobuki.git
...
Check the [Issue Tracker](https://github.com/helloric/docker-env-kobuki/issues) for roadmap planning. 